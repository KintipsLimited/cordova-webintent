...
public class WebIntent extends CordovaPlugin {
    ...
    void startActivity(String action, Uri uri, String type, Map<String, String> extras) {
        ...
        // Have customize this plugin to change "startActivity" to "startActivityForResult" with param "200"(ADD_PACK) to fix the andorid 12+ whats app sticker issue.
        // ((CordovaActivity)this.cordova.getActivity()).startActivity(i); <--- Original code
        ((CordovaActivity)this.cordova.getActivity()).startActivityForResult(i, 200);
    }
